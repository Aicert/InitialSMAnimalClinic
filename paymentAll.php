                                    ...
                                    <div id="tableId_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer"><div class="row"><div class="col-sm-12 col-md-6"><div class="dataTables_length" id="tableId_length"><label>Show <select name="tableId_length" aria-controls="tableId" class="custom-select custom-select-sm form-control form-control-sm"><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select> entries</label></div></div><div class="col-sm-12 col-md-6"><div id="tableId_filter" class="dataTables_filter"><label>Search:<input type="search" class="form-control form-control-sm" placeholder="" aria-controls="tableId"></label></div></div></div><div class="row"><div class="col-sm-12"><table id="tableId" class="table table-bordered table-striped dataTable no-footer" role="grid" aria-describedby="tableId_info">
                                        <thead>
                                            <tr role="row"><th class="no-sort sorting_disabled" rowspan="1" colspan="1" aria-label="
                                                ...
                                                </th><th class="sorting" tabindex="0" aria-controls="tableId" rowspan="1" colspan="1" aria-label="Patient Name: activate to sort column ascending" style="width: 141px;">Patient Name</th><th class="sorting" tabindex="0" aria-controls="tableId" rowspan="1" colspan="1" aria-label="Doctor Name: activate to sort column ascending" style="width: 136px;">Doctor Name</th><th class="sorting" tabindex="0" aria-controls="tableId" rowspan="1" colspan="1" aria-label="Service Name: activate to sort column ascending" style="width: 140px;">Service Name</th><th class="sorting" tabindex="0" aria-controls="tableId" rowspan="1" colspan="1" aria-label="Charges: activate to sort column ascending" style="width: 89px;">Charges</th><th class="sorting" tabindex="0" aria-controls="tableId" rowspan="1" colspan="1" aria-label="Discount (%): activate to sort column ascending" style="width: 122px;">Discount <small>(%)</small></th><th class="sorting" tabindex="0" aria-controls="tableId" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 89px;">Status</th></tr>
                                        </thead>
                                        <tbody>   
